...
- **ARM 引擎机(`10.10.10.45`)**:NanoPi R2S,RK3328 四核 Cortex-A53,
  可用内存 968 MiB,WAN 为 1 GbE USB 网卡 `enxbada2e0076a1`。使用相同
  `lab` netns 拓扑,direct 对照约 0.8–0.9 Gbps。
...
- 不对跨架构绝对吞吐作归一化:`.49` 是虚拟多千兆路径,`.45` 同时受 USB
