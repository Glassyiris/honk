...
Different qualified response cohorts create a response-alignment gap for the selected control and participating challengers, not a transfer-only wait. Existing budgets and in-flight limits govern the four-reporter demand; ordinary forwarding supplies control observations. Missing pairs, capped candidates and partial target coverage retain their own existing gap rules. No extra probes, copied requests or completion guarantee for arbitrary offered traffic are introduced.
