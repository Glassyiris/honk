...
- **UDP support matrix** (verified): `dial_udp` works for direct, socks5, shadowsocks (+2022), trojan, hysteria2, anytls, tuic, juicity. **Not implemented for vmess, vless** (matches the README TODO).
