...
#   5. honk-core control tests (probers / resolver wiring)
#   6. honk-outbound full suite (alive/urltest/bootstrap/quic transports)
#
# Usage: ci/dns-ci.sh
set -eu
...
step "cargo test -p honk-core (dns + control)"
